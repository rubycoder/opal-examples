...
(function(Opal) {
  ...
  (function($base) {
    ...
    Opal.defn(self, '$handle', function(event_type, selector, method_sym) {
      var $a, $b, TMP_1, self = this;

      return ($a = ($b = $scope.get('Element')['$[]'](selector)).$on, $a.$$p = (TMP_1 = function(event){var self = TMP_1.$$s || this;
if (event == null) event = nil;
      return self.$send(method_sym, event)}, TMP_1.$$s = self, TMP_1), $a).call($b, event_type);
    })
  })(self);
  (function($base, $super) {
    function $MyWidget(){};
    var self = $MyWidget = $klass($base, $super, 'MyWidget', $MyWidget);
    ...
    def.$add_entrant = function(event) {
      var self = this, entrant_field = nil;
    ...
    def.$remove_entrant = function(event) {
      var self = this, entrant_field = nil;

      entrant_field = "#entrant_"['$+'](self.number_entrants.$to_s());
      $scope.get('Element')['$[]'](entrant_field).$parent().$remove();
      self.number_entrants = self.number_entrants['$-'](1);
      return self.$puts("Number of entrants: " + (self.number_entrants));
    };
...
if (div == null) div = nil;
  ...
  return my_widget = $scope.get('MyWidget').$new()}, TMP_3.$$s = self, TMP_3), $a).call($b);
})(Opal);
